...
/*#########################  Content Part  #################################*/
	...
	public function mailing_list(){
       ...
       <p><span style="color:red">All fields are required</span></p>
		...
		<h2>List of subscribed users</h2> <?php        
		$this->generete_subscriber_table_lists($mailing_lists);
		?><h2>Subscribed users emails list</h2><p><span style="color:red">You can copy emails list and send emails using Gmail or other email services.</span></p> <?php  
