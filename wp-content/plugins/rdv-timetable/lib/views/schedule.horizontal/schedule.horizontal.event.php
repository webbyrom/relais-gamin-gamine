<?php
$event_start = $this->calculate_event_start_horizontal($event);
$event_length = $this->calculate_event_length_horizontal($event);
echo SCHED_HTML::elem('a', array(
	...
	// 'style' => 'width: '.$event_length.'px; top: '.($row_height*$column_i).'px; left: '.$event_start.'px; height: '.$this->get('h_row_height').'px',
	'style' => 'width: '.$event_length.'px; left: '.$event_start.'px;',
