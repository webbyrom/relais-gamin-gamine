...
<?php echo $s; ?> .sched-h-columns {
	margin-top: <?php echo $this->get('h_time_indicator_height'); ?>px;
}

<?php echo $s; ?> .sched-h-content-columns {
	/*margin-top: <?php echo $this->get('h_time_indicator_height'); ?>px;*/
}
...
<?php echo $s; ?> .sched-h-columns {
	width: <?php echo $this->get('h_column_width'); ?>px;
}

<?php echo $s; ?> .sched-h-content {
	margin-left: <?php echo $this->get('h_column_width'); ?>px;
}

<?php echo $s; ?> .sched-h-column-title {
	text-align: <?php echo $this->get('h_column_title_align'); ?>;
}

<?php echo $s; ?> .sched-h-column {
	background: <?php echo $this->get('column_color_bg'); ?>;
	color: <?php echo $this->get('column_color_text'); ?>;
}

<?php echo $s; ?> .sched-h-row {
	background-color: <?php echo $this->get('h_bg_color'); ?>;
}
